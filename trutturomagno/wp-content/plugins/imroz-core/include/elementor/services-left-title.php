...
class Imroz_Elementor_Widget_Services extends Widget_Base
{
    ...
    {
        return 'imroz-services';
    }

    public function get_title()
    {
        return esc_html__('Services With Left Title', 'imroz');
    }
    ...
    {
        return ['services', 'main home services', 'left title services', 'imroz'];
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    '1' => esc_html__( 'Style 1', 'imroz' ),
                    '2' => esc_html__( 'Style 2', 'imroz' ),
                ],
                'default' => '1',
                'style_transfer' => true,
            ]
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Read More Link', 'imroz' ),
        ...
        $this->add_control(
            'service_read_more_link_text', [
                'label' => esc_html__('Read More Link Text', 'imroz'),
...
Plugin::instance()->widgets_manager->register_widget_type(new Imroz_Elementor_Widget_Services());
